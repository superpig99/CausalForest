...
#ifndef GRF_UDCFPREDICTIONSTRATEGY_H
#define GRF_UDCFPREDICTIONSTRATEGY_H
...
class UDCFPredictionStrategy final: public OptimizedPredictionStrategy {
public:

  UDCFPredictionStrategy(size_t num_treatments,
                                size_t num_outcomes);
...
#endif //GRF_UDCFPREDICTIONSTRATEGY_H
