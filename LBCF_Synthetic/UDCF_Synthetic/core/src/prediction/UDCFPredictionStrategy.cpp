...
#include "prediction/UDCFPredictionStrategy.h"

namespace grf {

UDCFPredictionStrategy::UDCFPredictionStrategy(size_t num_treatments,
                                                             size_t num_outcomes) {
...
size_t UDCFPredictionStrategy::prediction_length() const {
    return num_treatments * num_outcomes;
}

std::vector<double> UDCFPredictionStrategy::predict(const std::vector<double>& average) const {
...
std::vector<double> UDCFPredictionStrategy::compute_variance(
...
size_t UDCFPredictionStrategy::prediction_value_length() const {
  return num_types;
}

PredictionValues UDCFPredictionStrategy::precompute_prediction_values(
...
std::vector<std::pair<double, double>> UDCFPredictionStrategy::compute_error(
    size_t sample,
    const std::vector<double>& average,
    const PredictionValues& leaf_values,
    const Data& data) const {
